...
hr.dashed_line {
  //   background: url(../assets/images/templates/hr-dashed.png) 0 0 repeat-x;
  border: none;
  margin: 28px 5px -6px;
}
hr:last-child {
...
// .common__icons {
//   background: url(../assets/images/icons/common_icons.png) no-repeat;
// }
audio,
canvas,
img,
...
.with_marker li:before {
  content: "";
  display: block;
  //   background: url(../assets/images/templates/ul-dot.png) 0 0 no-repeat;
  width: 4px;
  height: 4px;
  top: 6px;
  left: 0;
...
.important_text {
  ...
  margin: 35px 0 30px;
  //   background: url(../assets/images/templates/important.png) 17px 24px no-repeat;
}
.important_text p {
  font-size: 16px;
  line-height: 24px;
...
.top_auth_register {
  color: #fc3;
  text-decoration: none;
  border-bottom: 1px solid rgba(255, 204, 51, 0.5);
  line-height: 46px;
}
...
.head .logo {
  ...
  margin: 0 5px;
  vertical-align: middle;
  //   background: url(../assets/images/templates/logo.png) 0 0 no-repeat;
  width: 240px;
  height: 100px;
}
.head .logo a {
...
.head_wrapper.scroll__fixed .request_small_form {
  background: transparent url(../assets/images/templates/el.png) no-repeat -90px
    0;
  content: "";
  display: block;
  height: 30px;
...
.head_wrapper.scroll__fixed .request_small_form:hover {
  //   background: transparent url(../assets/images/icons/serch-hover.png) no-repeat
  // 50%;
  background-size: 50%;
}
...
//   background: url(../assets/images/templates/comp.svg) 0 0 no-repeat;
// }
// .footer_top_item_ico_quality {
//   background: url(../assets/images/templates/roal.svg) 0 0 no-repeat;
// }
// .footer_top_item_ico_delivery {
//   background: url(../assets/images/templates/delivery.svg) 0 0 no-repeat;
// }
// .footer_top_item_ico_return {
//   background: url(../assets/images/templates/cartup.svg) 0 0 no-repeat;
// }
...
.reviews__item a:before {
  ...
  fill: #fff;
  float: left;
  //   background: url(../assets/images/icons/reviews_icon.svg) no-repeat;
}
.vk__link {
...
.ic_present {
  width: 33px;
  height: 47px;
  //   background: url(../assets/images/templates/present.svg) 0 0 no-repeat;
}
.ic_like {
  width: 30px;
  height: 35px;
...
.ic_excel {
  //   background: url(../assets/images/templates/ic-excel.png) 0 0 no-repeat;
  width: 28px;
  height: 27px;
  margin-right: 7px;
}
...
.checkbox_input_small .checkbox_button {
  ...
  left: 3px;
  transition: all 0.15s ease-in-out;
  //   background: url(../assets/images/templates/check-big.svg) 0 0 no-repeat;
  transform: translate(0);
}
.checkbox_input_small .checkbox_button {
  //   background: url(../assets/images/templates/check.svg) 0 0 no-repeat;
  width: 10px;
  height: 10px;
  top: 5px;
  left: 5px;
...
.stepper-arrow {
  background: #fff url(../assets/images/templates/jquery.fs.stepper-arrows.png)
    no-repeat;
  border: 1px solid #ccc;
  cursor: pointer;
  display: block;
...
.pagination_container .load__pages:after {
  ...
  width: 30px;
  height: 30px;
  //   background: url(../assets/images/icons/load__i.png) 100% no-repeat;
}
.tab_container {
  margin: 0 5px 20px;
}
...
.modal_cart_info .product_full_description_name,
.modal_cart_info .product_full_description_value,
.modal_cart_info .product_full_description p:not(.section_title) {
  font-size: 14px;
}
...
.column_left_submenu_item_current:before {
  ...
  margin-top: -6px;
  left: 0;
  //   background: url(../assets/images/templates/arrow-right-black.svg) 0 0
  //     no-repeat;
  width: 6px;
  height: 12px;
}
...
.column_left_delivery_variant_label:hover
  .column_left_delivery_variant_label_name {
  border-bottom: 1px dotted #000;
}
...
.main__svg_banner {
  width: 490px;
  height: 270px;
  //   background: url(../assets/images/source/banner_remont.png) no-repeat;
  margin-bottom: 10px;
}
.lef__svg_banner {
  width: 240px;
  height: 400px;
  //   background: url(../assets/images/banners/PNG/BAN20.png) no-repeat;
  margin-top: -2px;
}
.main__svg_banner_msc {
  width: 490px;
  height: 270px;
  //   background: url(../assets/images/banners/PNG/BAN30.png) no-repeat;
  margin-bottom: 10px;
}
.f__main_banner {
  //   background: url(../assets/images/banners/PNG/BAN40.png) no-repeat;
}
.f__main_banner,
.s__main_banner {
  width: 240px;
...
.s__main_banner {
  //   background: url(../assets/images/banners/PNG/BAN50.png) no-repeat;
}
.j__main_banner {
  width: 240px;
  height: 270px;
  //   background: url(../assets/images/banners/SVG/BAN60.svg) no-repeat;
  margin-bottom: 10px;
}
...
.column_right_delivery_order .delivery_final .delivery_total_price_container {
  //   background: url(../assets/images/templates/hr-dashed-b.png) 0 0 repeat-x;
  padding: 20px 0 0;
  float: none;
}
...
.product .product_description .sticker_time {
  top: -222px;
  right: -10px;
  //   background: url(../assets/images/icons/sticker_time-h.svg) 0 0 no-repeat;
  width: 47px;
  height: 29px;
}
...
.product_horizontal .product_options.notInStock__item {
  ...
  bottom: inherit;
  left: inherit;
  //   background: url(../assets/images/templates/sticker_time.svg) no-repeat;
  cursor: pointer;
}
...
@media (min-width: 1250px) {
  ...
  .gift__field:before {
    ...
    top: 11px;
    left: 12px;
    // background: url(../assets/images/icons/services_gifts.png) no-repeat;
  }
}
.solitary__wrapper {
  position: relative;
...
.sticker_hot {
  top: 0;
  //   background: url(../assets/images/templates/sticker_hot.svg) 0 0 no-repeat;
  width: 75px;
  height: 50px;
}
.sticker_hot,
...
.sticker_new {
  bottom: 20px;
  //   background: url(../assets/images/templates/sticker_new.svg) 0 0 no-repeat;
  width: 77px;
  height: 34px;
}
.sticker_discount {
  //   background: url(../assets/images/templates/sticker_discount.svg) 0 0 no-repeat;
  width: 36px;
  height: 35px;
  bottom: 20px;
}
...
.sticker_x3 {
  //   background: url(../assets/images/templates/sticker_3.svg) 0 0 no-repeat;
  width: 47px;
  height: 32px;
  bottom: 32px;
}
.sticker_time {
  //   background: url(../assets/images/templates/sticker_time.svg) 0 0 no-repeat;
  width: 29px;
  height: 41px;
  position: absolute;
  top: 0;
...
.cart_row_content {
  position: relative;
  display: table;
  //   background: url(../assets/images/templates/hr-dashed.png) 0 100% repeat-x;
  padding: 8px 0 20px;
}
.cart_row_content:before {
  content: counter(a) ".";
...
@media (min-width: 0px) and (max-width: 999px) {
  ...
  .cart_row_content .product_description .sticker_time {
    top: 250px;
    right: 0;
    // background: url(../assets/images/icons/sticker_time.svg) 0 0 no-repeat;
    width: 29px;
    height: 41px;
  }
  .cart_row_content .product_options {
...
.product_full_info_points {
  display: inline-block;
  position: relative;
  //   background: #ebebeb url(../assets/images/templates/sticker_friends.png) 6px 0
  // no-repeat;
  height: 30px;
  min-width: 90px;
  font-size: 12px;
...
.delivery_form_step_content
  .delivery_address_recent
  .delivery_address_more_recent
  > a {
  text-decoration: underline;
  font-weight: 700;
  color: #000;
...
.question_one {
  ...
  max-height: 40px;
  overflow: hidden;
  transition: max-height 0.25s ease-in-out, background-color 0.15s ease-in-out;
}
.question_one_header {
  font-size: 16px;
  line-height: 20px;
...
.question_one_link:before {
  ...
  width: 13px;
  height: 13px;
  //   background: url(../assets/images/templates/plus.svg) 0 0 no-repeat;
  position: absolute;
  top: 12px;
  left: 10px;
  fill: #666;
...
.question_one_open .question_one_link:before {
  ...
  height: 3px;
  top: 16px;
  //   background: url(../assets/images/templates/minus.svg) 0 0 no-repeat;
}
...
.order_container .cart_row_col_price,
.order_container .cart_row_col_quantity,
.order_container .cart_row_col_weight {
  width: 150px;
}
.order_container .cart_row_content .cart_row_col_price,
.order_container .cart_row_content .cart_row_col_price_total,
.order_container .cart_row_content .cart_row_col_weight {
  padding-top: 22px;
}
...
.customer_profiles_link_delete,
.customer_profiles_link_edit {
  display: inline-block;
  margin-right: 4px;
}
.customer_profiles_link_delete .ic,
.customer_profiles_link_edit .ic {
  display: none;
}
@media (min-width: 0px) and (max-width: 999px) {
  .customer_profiles_table {
  ...
  .customer_profiles_link_delete span,
  .customer_profiles_link_edit span {
    display: none;
  }
  .customer_profiles_link_delete .ic,
  .customer_profiles_link_edit .ic {
...
@media (min-width: 0px) and (max-width: 999px) {
  ...
  .estimate_container .cart_row_content .cart_row_col_price_total,
  .estimate_container .cart_row_content .cart_row_col_weight {
    padding-top: 72px;
  }
...
.collection_dot_link:hover,
.collection_dot_link_active {
  border-color: #ed1c24;
}
.collection_content {
  position: absolute;
...
@media (min-width: 0px) and (max-width: 999px) {
  ...
  .collection_content .collection_close:before {
    content: "";
    display: block;
    // background: url(../assets/images/templates/bg-angle.png) 0 0 no-repeat;
    width: 123px;
    height: 154px;
    position: absolute;
    bottom: -17px;
...
.suggest__wrapper .suggest__example.suggest__active,
.suggest__wrapper .suggest__example:hover {
...
.services__i {
  ...
  width: 34px;
  height: 25px;
  //   background: url(../assets/images/icons/services_icons_edit.png) no-repeat;
  cursor: pointer;
}
...
.services__i.blade_runner {
  //   background: url(../assets/images/icons/actions/gift__icons.png) 50% no-repeat;
  background-size: contain;
}
.services__i.ceresit {
  //   background: url(../assets/images/icons/actions/ceresit__icons.png) 50%
  //     no-repeat;
  background-size: contain;
}
.services__i.thumbs {
  //   background: url(../assets/images/icons/actions/thumbs__icons.png) 50%
  //     no-repeat;
  background-size: contain;
}
.services__i.oae {
  //   background: url(../assets/images/icons/actions/oae__icons.png) 50% no-repeat;
  background-size: contain;
}
.services__i.cigel {
  //   background: url(../assets/images/icons/actions/cigel__icons.png) 50% no-repeat;
  background-size: contain;
}
.services__i.double {
  //   background: url(../assets/images/icons/actions/x2__icons.png) no-repeat;
  background-size: contain;
  width: 35px;
}
...
.ymaps-2-1-34-image:hover,
.ymaps-image:hover {
  //   background-image: url(../assets/images/icons/map-tag-active1.png);
}
.address_one:hover {
  cursor: pointer;
}
...
.page--preloader p {
  ...
  border-left: 0.4em solid #ff001d;
  transform: translateZ(0);
  animation: b 1s infinite linear;
  z-index: 999;
}
.page--preloader p,
.page--preloader p:after {
  border-radius: 50%;
}
@keyframes b {
  0% {
...
.page__404 {
  ...
  width: 935px;
  height: 550px;
  //   background: url(../assets/images/templates/404.png) no-repeat;
  background-size: 100%;
  margin: 20px auto;
}
...
.absolute-item .more__title .item_exit {
  //   background: url(../assets/images/icons/krestik-off.png);
}
.absolute-item .more__title .item_exit,
...
.absolute-item .more__title .item_exit:hover {
  //   background: url(../assets/images/icons/krest-on.png);
  background-size: 100%;
}
...
.one-item-akcii .akcii-info-bottom {
  height: 140px;
  //   background: url(../assets/images/pages/actions/orange-bg.png) no-repeat;
  background-size: 100%;
  background-position: bottom;
...
.one-item-akcii .how-long:before {
  ...
  position: absolute;
  left: -30px;
  //   background: url(../assets/images/pages/actions/akcii-clock.png);
}
...
.one-item-akcii .button-down,
.one-item-akcii .button-up {
  height: 20px;
  border: 1px solid #ccc;
  box-sizing: border-box;
  cursor: pointer;
...
.one-item-akcii .button-up {
  border-bottom: 1px solid #ccc;
  //   background: url(../assets/images/pages/actions/arrow-up.png) no-repeat 50%;
}
.one-item-akcii .button-down {
  //   background: url(../assets/images/pages/actions/arrow-down.png) no-repeat 50%;
}
.one-item-akcii .button-up:hover {
  //   background: url(../assets/images/pages/actions/arrow-up-hover.png) no-repeat
  //     50%;
}
.one-item-akcii .button-down:hover {
  //   background: url(../assets/images/pages/actions/arrow-down-hover.png) no-repeat
  //     50%;
}
.one-item-akcii .akcion-input {
  width: 100%;
  height: 100%;
  box-sizing: border-box;
  text-align: center;
...
@media only screen and (max-width: 1024px) {
  ...
  .one-item-akcii .akcii-info {
    ...
    width: 100%;
    height: 60px;
    // background: url(../assets/images/pages/actions/mobile-akcii-bg.png)
    //   no-repeat 100%;
    padding: 0;
  }
  .one-item-akcii .akcii-info-cup {
...
.sertificates-catalog .button-down,
.sertificates-catalog .button-up {
  height: 20px;
  border: 1px solid #ccc;
  box-sizing: border-box;
  cursor: pointer;
...
// .sertificates-catalog .button-up {
//   border-bottom: none;
//   background: url(../assets/images/sertificates/arrow-up.png) no-repeat 50%;
// }
// .sertificates-catalog .button-down {
//   background: url(../assets/images/sertificates/arrow-down.png) no-repeat 50%;
// }
// .sertificates-catalog .button-up:hover {
//   background: url(../assets/images/sertificates/arrow-up-hover.png) no-repeat 50%;
// }
// .sertificates-catalog .button-down:hover {
//   background: url(../assets/images/sertificates/arrow-down-hover.png) no-repeat
//     50%;
// }
...
.sertificates-catalog .span-cart-box {
  display: inline-block;
  box-sizing: border-box;
  font-size: 15px;
}
...
.sertificates-catalog .price .btn_cart,
.sertificates-catalog .price .product_count_wrapper {
  bottom: 20px;
}
...
.registration-static-page .float_left,
.registration-static-page .float_right {
  float: none;
}
...
.form_inner .mainPetrovichLogin_login_error,
.form_inner .mainPetrovichLogin_password_error {
  color: #fff;
}
...
.fotorama__video-close,
.fotorama__video-play {
  background: url(../assets/images/icons/product/fotorama__i.png) no-repeat;
}
...
.product--detail-info .product--special-info .product--club {
  ...
  width: 190px;
  height: 30px;
  background: url(../assets/images/icons/product/cloub--i.png) no-repeat;
  float: left;
  margin: 0 0 20px;
}
...
.product--detail-info
  ...
  .product--stock
  span.stock--thumbs {
  //   background: url(../assets/images/icons/actions/thumbs__icons.png) no-repeat;
}
.product--detail-info
  .product--special-info
  .product--stock
  span.stock--ceresit {
  //   background: url(../assets/images/icons/actions/ceresit__icons.png) no-repeat;
}
.product--detail-info .product--special-info .product--stock span.stock--cigel {
  //   background: url(../assets/images/icons/actions/cigel__icons.png) no-repeat;
  background-size: 100% !important;
}
.product--detail-info .product--special-info .product--stock span.stock--oae {
  //   background: url(../assets/images/icons/actions/oae__icons.png) no-repeat;
  background-size: 100% !important;
}
.product--detail-info
  .product--special-info
...
.product--detail-info
  .product--services-info
  .product--service-i
  span.i__isDeliveryTo15 {
  background-position: 0 0;
}
.product--detail-info
  .product--services-info
  .product--service-i
  span.i__isDeliveryTo18 {
  background-position: -350px 0;
}
.product--detail-info
  .product--services-info
...
.product--detail-info
  .product--services-info
  .product--service-i
  span.i__isDeliveryTo36 {
  background-position: -455px 0;
}
.product--detail-info
  .product--services-info
  .product--service-i
  span.i__isDeliveryTo35 {
  background-position: -565px 0;
}
.product--detail-info
  .product--services-info
  .product--service-i
  span.i__isDeliveryTo5 {
  background-position: -35px 0;
}
.product--detail-info
  .product--services-info
  .product--service-i
  span.i__isManipulator {
  background-position: -70px 0;
}
.product--detail-info
  .product--services-info
...
.product--detail-info
  .product--services-info
  .product--service-i
  span.i__isNoLiftLifting {
  background-position: -140px 0;
}
.product--detail-info
  .product--services-info
  .product--service-i
  span.i__isNoPassengerLift {
  background-position: -385px 0;
}
.product--detail-info
  .product--services-info
...
.product--detail-info
  ...
  .product--service-i
  span.stock--oae {
  //   background: url(../assets/images/icons/actions/oae__icons.png) 0 0 no-repeat;
...
.product--detail-info
  .product--stock-info.action--burns
  .product--stock-i
  span.stock--img {
  //   background: url(../assets/images/templates/sticker_hot.svg) no-repeat;
  height: 50px;
  width: 75px;
}
.product--detail-info
  .product--stock-info.action--novelty
  .product--stock-i
  span.stock--img {
  //   background: url(../assets/images/templates/sticker_new.svg) no-repeat;
  height: 35px;
  width: 75px;
}
.product--detail-info
  .product--stock-info.action--profit
  .product--stock-i
  span.stock--img {
  //   background: url(../assets/images/templates/sticker_discount.svg) no-repeat;
  height: 35px;
  width: 40px;
}
.product--detail-info
  .product--stock-info.action--instock
  .product--stock-i
  span.stock--img {
  //   background: url(../assets/images/templates/sticker_time.svg) no-repeat;
  height: 35px;
...
.product--detail-info
  .product--stock-info.action--double
  .product--stock-i
  span.stock--img {
  //   background: url(../assets/images/icons/actions/x2__icons.png) no-repeat;
  background-size: contain;
...
.product--prices .product--to-cart .to-cart--count span:after {
  ...
  width: 25px;
  height: 19px;
  background: url(../assets/images/icons/product/count--i.png) no-repeat;
}
...
.product--prices
  .product--to-cart
  .to-cart--button
  .tc--button.btn_cart_already,
.product--prices
  .product--to-cart
  .to-cart--button
  .tc--button.btn_cart_already:hover {
  background: #999;
  cursor: default;
}
